...
public class Tokenizer implements Words{
	 ...
	 * @return
	 */
	public int getTotalNumberFiles()
	{
	...
	public void setFileTitle(String fileContent)
	{
		fileTitle = fileContent.substring(fileContent.indexOf("<TITLE>")+7, fileContent.indexOf("</TITLE>")).trim();
	}
...
//        TreeSet<PostingList> top30Words = getMostFrequentWordsWithFrequency(30);
//        Iterator<PostingList> top30WordsIterator = top30Words.descendingIterator(); 
////        Iterator<WordWithFrequency> top30WordsIterator = top30Words.iterator(); 
//        
//        System.out.println("Word\tCount");
//        while (top30WordsIterator.hasNext()) {
//        	PostingList listItem = top30WordsIterator.next();
//            System.out.println(listItem.getStem() +"\t"+ listItem.getFrequency());
//        }
//        
...
//	@Override
	public int countSingleOccuringWords() {
		// TODO Auto-generated method stub
		int count = 0;
...
//	@Override
	public TreeSet<PostingList> getMostFrequentWordsWithFrequency(int number) {
		// TODO Auto-generated method stub		
		TreeSet<PostingList> mostFrequentWords = new TreeSet<PostingList>(new Comparator<PostingList>() {
...
//			@Override
		...
		for(String term : terms.keySet())
		{
			PostingList word = new PostingList();
